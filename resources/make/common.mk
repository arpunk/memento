...
get-version:
	...
	-eval "lfe_io:format(\"~p~n\",['memento-util':'get-versions'()])." \
...
repl: compile
	...
	@PATH=$(SCRIPT_PATH) ERL_LIBS=$(ERL_LIBS) $(LFETOOL) repl lfe +pc unicode -s memento
...
shell: compile
	...
	@PATH=$(SCRIPT_PATH) ERL_LIBS=$(ERL_LIBS) erl +pc unicode -s memento
